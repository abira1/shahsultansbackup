    ...
    <div className="min-h-screen bg-[#e6eef8]">
      ...
      <div className="flex justify-center items-start pt-12 px-6">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl w-full">
          <h2 className="text-xl font-semibold text-gray-800 mb-6">Listening Practice Test</h2>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-100 p-3 rounded">
                ...
                <div className="font-medium text-gray-800">30 minutes</div>
              </div>
              <div className="bg-gray-100 p-3 rounded">
              ...
              <div className="bg-gray-100 p-3 rounded">
                ...
                <div className="font-medium text-gray-800">Multiple Choice, Form Completion</div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-md hover:shadow-lg"
            >
